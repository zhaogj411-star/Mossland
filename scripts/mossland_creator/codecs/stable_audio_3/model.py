...
from .inference.audio_utils import prepare_audio, numpy_audio_to_tensor
from .inference.sampling import sample_diffusion
from .loading_utils import load_autoencoder, load_diffusion_cond
from .model_configs import ae_models, all_models
...
class AutoencoderModel:
    ...
    @torch.inference_mode()
    def encode(self, audio, sr, chunked=False, chunk_size=4096, overlap=32):
    ...
    @torch.inference_mode()
    def decode(self, latents, chunked=False, chunk_size=4096, overlap=32):
