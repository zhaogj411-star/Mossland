...
DEFAULT_INPUT_AUDIO ='/inspire/sj-ssd3/project/embodied-multimodality/public/zhaoguojie/Mossland/tmp/data/YaKio,Wehti,Trispect - Losing You.flac'
DEFAULT_OUTPUT_DIR = os.path.join(REPO_ROOT, "tmp/mossland-codec-infer")
